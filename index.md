...
<section id="department-instructors">
...
- **LaTeX Setup Guide (Windows) - VS Code + Overleaf**  
  Access: [Install Guide]({{ site.baseurl }}/materials/install-guide.html) - Local LaTeX compilation with LaTeX Workshop for final report/paper preparation
...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 1 | **Lecture** | Course Introduction & Excel Basics | Course overview, analytics workflow, Excel interface, essential formulas (SUM, AVERAGE, COUNT, IF, VLOOKUP)<br><br><strong>Materials:</strong> [Week 1 Slides]({{ site.baseurl }}/materials/1.Intro.pdf) · [Lab 1 Instructions]({{ site.baseurl }}/lab-1-instructions) · [Week 1 Quiz]({{ site.baseurl }}/quiz/week1) | [1] Ch. 1 | CLO 1 | Participation |
| 2 | **Lab** | Excel Basics Practice | Hands-on practice with formulas and functions; **Group Progress Report 1:** Topic selection, problem statement, research questions, and initial data exploration plan <br> [Lab 01 Answers]({{ site.baseurl }}/labs/lab_01-Product_Inventory) | [1] Ch. 1 | CLO 1 | Lab Assignment 1 + Group Progress Report 1 |
| 3 | **Lecture** | Data Import & Cleaning | Import from CSV/Excel/web, Power Query basics, data cleaning, handling missing values<br><br><strong>Materials:</strong> [Week 3 Slides]({{ site.baseurl }}/materials/2.%20Power%20Query.pdf) · [Lab 2 Instructions]({{ site.baseurl }}/lab-2-instructions-nokeys.html) · [Lab 2 Answers]({{ site.baseurl }}/lab-2-instructions-withkeys.html) · [Lab 2 Dataset (Google Drive)](https://drive.google.com/drive/folders/1F92S9FEN5SWvUQsEXIs9c1J4q90uARCm?usp=sharing) | [1] Ch. 2-3 | CLO 1 | - |
| 4 | **Lab** | Data Import & Cleaning Practice | Import and clean datasets using Power Query; **Group Progress Report 2:** Data quality assessment, cleaning methodology, and preliminary data structure documentation<br><br><strong>Materials:</strong> [Lab 2 Instructions]({{ site.baseurl }}/lab-2-instructions-nokeys.html) · [Lab 2 Answers]({{ site.baseurl }}/lab-2-instructions-withkeys.html) · [Lab 2 Dataset (Google Drive)](https://drive.google.com/drive/folders/1F92S9FEN5SWvUQsEXIs9c1J4q90uARCm?usp=sharing) | [1] Ch. 2-3 | CLO 1 | Lab Assignment 2 + Group Progress Report 2 |
| 5 | **Lecture** | Exploratory Data Analysis | Descriptive statistics, summary tables, data segmentation, PivotTables<br><br><strong>Materials:</strong> [Week 5 Slides]({{ site.baseurl }}/materials/3.%20EDA.pdf) · [Lab 3 Instructions]({{ site.baseurl }}/lab-3-instructions-nokeys.html) · [Lab 3 Answers]({{ site.baseurl }}/lab-3-instructions-withkeys.html) · [Lab 3 Dataset (Google Drive)](https://drive.google.com/drive/folders/1y-NlhblrVs3lUUQgfXCnbG2lBJWeRkBE?usp=sharing) | [1] Ch. 4; [2] Ch. 8 | CLO 2 | - |
| 6 | **Lab** | EDA Practice | Perform descriptive analysis and create PivotTables; **Group Progress Report 3:** Descriptive statistics summary, key patterns/insights relevant to research questions, and identification of variables for further analysis<br><br><strong>Materials:</strong> [Lab 3 Instructions]({{ site.baseurl }}/lab-3-instructions-nokeys.html) · [Lab 3 Answers]({{ site.baseurl }}/lab-3-instructions-withkeys.html) · [Lab 3 Dataset (Google Drive)](https://drive.google.com/drive/folders/1y-NlhblrVs3lUUQgfXCnbG2lBJWeRkBE?usp=sharing) | [1] Ch. 4 | CLO 2 | Lab Assignment 3 + Group Progress Report 3 |
| 7 | **Lecture** | Data Visualization & Dashboards | Chart types, design principles, effective visualizations, interactive dashboards<br><br><strong>Materials:</strong> [Week 7 Slides]({{ site.baseurl }}/materials/4.%20Visualization.pdf) | [1] Ch. 9, 28-29 | CLO 4 | - |
| 8 | **Lab** | Visualization Practice | Create charts and build interactive dashboards; **Group Progress Report 4:** Visual analysis of key research variables, preliminary dashboard prototype, and visual insights that address specific research questions<br><br><strong>Materials:</strong> [Lab 4 Instructions]({{ site.baseurl }}/lab-4-instructions-nokeys.html) · [Lab 4 Answers]({{ site.baseurl }}/lab-4-instructions-withkeys.html) · [Lab 4 Dataset (Google Drive)](https://drive.google.com/drive/folders/1A-0f3e6tSTmJMI-STYTqXdLkl4r2dDuc?usp=sharing) | [1] Ch. 9 | CLO 4 | Lab Assignment 4 + Group Progress Report 4 |
| 9 | **Lecture** | Statistical Analysis & Regression | Hypothesis testing basics, simple regression, interpreting results<br><br><strong>Materials:</strong> [Week 9 Slides]({{ site.baseurl }}/materials/5.%20Regression.pdf) | [2] Ch. 2-6 | CLO 3 | - |
| 10 | **Midterm** | Midterm Exam | Comprehensive exam covering weeks 1-9 (Excel basics, data import, EDA, visualization, statistics)<br><br><strong>Materials:</strong> [Midterm Answer Key]({{ site.baseurl }}/midterm-lab-instructions-withkeys.html) | Review materials | CLO 1-4 | Midterm Exam (30%) |
...
| 12 | **Lecture** | Professional Reporting & Communication | Report structure, writing for audiences, presenting insights effectively; Overleaf workflow; VS Code + LaTeX Workshop local compilation (Windows)<br><br><strong>Materials:</strong> [Week 12 Slides]({{ site.baseurl }}/materials/6.Report.pdf) · [LaTeX Install Guide]({{ site.baseurl }}/materials/install-guide.html) | [1] Ch. 11; [3] Ch. 10 | CLO 5 | - |
| 13 | **Lab** | Final Project Work I | Complete analysis, build visualizations/dashboards, write report drafts; **Project Checkpoint:** Full analysis results, comprehensive dashboard addressing all research questions, draft report with methodology and findings sections<br><br><strong>Materials:</strong> [Lab 5 Instructions]({{ site.baseurl }}/lab-5-instructions-nokeys.html) · [Lab 5 Materials (Google Drive)](https://drive.google.com/drive/folders/15qUCPgzBI3AHUJovZCCOtayCSb_Bqkth?usp=sharing) | [Final Report & Presentation Guide]({{ site.baseurl }}/final-presentation-guide.html) | CLO 1-6 | Project Checkpoint |
| 14 | **Lab** | Final Project Work II | Refine analysis, finalize dashboards, complete written reports; Peer review and feedback | [Final Report & Presentation Guide]({{ site.baseurl }}/final-presentation-guide.html) | CLO 1-6 | Project Refinement |
| 15 | **Lab** | Final Presentations | Student group presentations (15 min each), Q&A, course wrap-up<br><br><strong>Materials:</strong> [Final Report & Presentation Guide]({{ site.baseurl }}/final-presentation-guide.html) | - | CLO 5,6 | Final Presentation (50%) |
...
- [Midterm Answer Key]({{ site.baseurl }}/midterm-lab-instructions-withkeys.html) (instructor grading reference)
...
Students work in groups (3-4 members) and select **one of 11 available topics** for their final project. Each topic is aligned with specific course knowledge areas and includes a curated dataset with instructions. See the [Topics page]({{ site.baseurl }}/topics) for detailed information on all available topics.
