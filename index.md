...
| 12 | **Lecture** | Professional Reporting & Communication | Report structure, writing for audiences, presenting insights effectively; Overleaf workflow; VS Code + LaTeX Workshop local compilation (Windows)<br><br><strong>Materials:</strong> [LaTeX Install Guide]({{ site.baseurl }}/materials/install-guide.html) · [Lab 5 Instructions]({{ site.baseurl }}/lab-5-instructions-nokeys.html) · [Lab 5 Materials (Google Drive)](https://drive.google.com/drive/folders/15qUCPgzBI3AHUJovZCCOtayCSb_Bqkth?usp=sharing) | [1] Ch. 11; [3] Ch. 10 | CLO 5 | - |
